...
Matching ranks a bundled demo directory against needs and user preferences. Saved matches, booking requests, therapist chat, and appointments persist to the account. Booking sends an internal request only; no external therapist or payment system is connected.
