...
- Name: onboarding.spec.js >> get started free opens the auth dialog in signup mode
- Location: tests\e2e\onboarding.spec.js:76:1

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('button', { name: 'Get started free' }) resolved to 2 elements:
...
> 79  |   await page.getByRole('button', { name: 'Get started free' }).click()
  ...
  114 |   releaseProfile()
  115 |   await expect(page.getByRole('heading', { name: /Avery\./ })).toBeVisible()
  116 | })
  117 | 
```